...
public class IntroUI extends JFrame {
	...
	private void initTextFields() throws IOException {
		...
		aProp.load(getClass().getResourceAsStream("/application.properties"));
			
		logo = new JLabel(new ImageIcon(image));
		teamName = new JLabel(aProp.getProperty("name"));
		teamLeader = new JLabel("Team leader " + aProp.getProperty("leader"));
		leaderMail = new JLabel(aProp.getProperty("leadermail"));
		teamMembers = new JLabel(
				aProp.getProperty("members"));
